...
function App() {
    ...
    return (
        <div className="App">
            {/* Snow Effect */}
            <Snowfall style={{ zIndex: 2 }} snowflakeCount={200} />
            {/* Home */}
            <div className="Home" style={{ display: home ? 'flex' : 'none' }}>
                <Header />
                <div className="header_text">
                    <span>merry christmas</span>
                </div>
                <div onClick={(e) => handleCloseHome(e)}>
                    <Button />
                </div>
            </div>
            {/* Card */}
            <div className="Card" style={{ display: home ? 'none' : 'flex' }}>
                ...
                <div className="card-container" style={{ display: card != '' ? 'flex' : 'none' }}>
                    <div className="card candy" style={{ display: card === 'candy' ? 'flex' : 'none' }}>
                        <IoMdClose
                            ...
                            style={{ fontSize: '30px', position: 'absolute', right: '20px', top: '10px' }}
                        />

                        <span className="card-detail">
                            Mỗi khoảnh khắc bên em là mỗi lần đắm chìm trong niềm vui và ý nghĩa. Anh chẳng còn điều gì
                            muốn hơn ngoài việc được làm cho em hạnh phúc và cùng em chia sẻ niềm vui của cuộc sống.
                        </span>
                    </div>
                    ...
                    <div className="card sock" style={{ display: card === 'sock' ? 'flex' : 'none' }}>
                        ...
                        <span className="card-detail">
                            Anh muốn em phải luôn giữ gìn sức khỏe .Chúng ta còn rất nhiều dự định , phải cùng nhau đi
                            nhiều nơi làm nhiều thứ nên sức khỏe quan trọng lắm .
                        </span>
                    </div>
                    ...
                    <div className="card leaves" style={{ display: card === 'leaves' ? 'flex' : 'none' }}>
                        ...
                        <span className="card-detail">
                            Chúc cho những điều tốt đẹp sẽ đến với em. Công việc sẽ luôn suôn sẻ, có những người đồng
                            nghiệp tốt. Cũng như mọi việc trong cuộc sống đều thuận lợi và may mắn .
                        </span>
                    </div>
                    ...
                    <div className="card milk" style={{ display: card === 'milk' ? 'flex' : 'none' }}>
                        ...
                        <span className="card-detail">
                            Em chính là người mang lại ý nghĩa và động lực cho cuộc sống anh. Anh rất trân trọng những
                            thời gian mình có với nhau. Anh cảm thấy mình cần phải thương và yêu em nhiều hơn nữa. Anh
                            yêu em ❤️
                        </span>
                    </div>
                </div>
              ...
              C28.7,24.7,28.9,27.7,29,28.2z"
                            ...
                            <path
                                fill="#E9646A"
                                d="M56.9,90.9c0,2.4,1.2,4.5,3.1,5.7l10.5-10.4V75.6L56.9,89.1V90.9z"
                            ></path>
